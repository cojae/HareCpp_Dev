...
inline int restartTestCheck(const int totalMsg, ProducerConsumerTester& pubsubTest) {
    pubsubTest.Restart();
    ...
    pubsubTest.Restart();
    pubsubTest.producer.Restart();
    pubsubTest.consumer.Restart();
...
TEST_F(ProducerConsumerTester, restartTest) {
